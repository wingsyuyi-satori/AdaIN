...
# decoder将一个14*14*512的feature map转换为224*224*3的图像
...
class Net(nn.Module):
    def __init__(self,encoder,decoder):
        ...
        self.enc_1 = nn.Sequential(*encode_layers[:4]) # 提取到第四层
        self.enc_2 = nn.Sequential(*encode_layers[4:9]) # 提取到第九层
        self.enc_3 = nn.Sequential(*encode_layers[9:16]) # 提取到第十六层
        self.enc_4 = nn.Sequential(*encode_layers[16:23]) # 提取到第二十三层
        self.enc_5 = nn.Sequential(*encode_layers[23:30]) # 提取到第三十层
        ...
        self.enc_5.requires_grad = False
    ...
    def forward(self, content, style):
        ...
        print(generated_img_tensor[0].shape)
